...
- **Claude Code attribution is allowed** on this project. Commits made with AI assistance should include the standard Claude Code trailer (`🤖 Generated with [Claude Code](https://claude.com/claude-code)` + a `Co-Authored-By: Claude` line).
...
- Claude Code attribution included on AI-assisted commits; no private/app names in code or docs.
